<div class="Orders index">
	...
	<tr>
		...
		<td><?php echo h($order['Table']['number']); ?>&nbsp;</td>
		<td><?php echo ($order['Order']['status']) ? '<span class="label label-success">Liberado</span>
' : '<span class="label label-warning">Não Liberado</span>
'; ?>&nbsp;</td>
