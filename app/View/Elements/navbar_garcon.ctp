  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li><?php echo $this->Html->link('Listar Mesas',array('controller' => 'tables','action' => 'garcon')); ?></li>
        <li><?php echo $this->Html->link('Efetuar Pedido',array('controller' => 'orders','action' => 'efetuar_pedido_garcon')); ?></li>
      </ul>
